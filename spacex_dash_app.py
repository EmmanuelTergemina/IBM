...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        values='class_count', 
        names='class', 
        title='Launch outcomes for ' + entered_site)
        return fig
...
def get_scatter_plot(entered_site, payload):
    ...
    if entered_site == 'ALL':
        ...
        title='Payload mass ({}-{} kg) vs. Launch outcome for all sites'.format(payload[0],payload[1]))
        return fig
    else:
        ...
        labels={'class':'Success Rate'},
        color="Booster Version Category",
        title='Payload mass ({}-{} kg) vs. Launch outcome for {}'.format(payload[0], payload[1], entered_site))
        return fig
